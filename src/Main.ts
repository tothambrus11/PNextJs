...
function sulypont(A: Vector2, B: Vector2, C: Vector2) : Vector2{
...
function magassagPont(A: Vector2, B: Vector2, C: Vector2) : Vector2{
    let AB = Vector2.fromTo(A,B); let lineAB = Line.createFromPointAndDirectionVector(A,AB);
    let BC = Vector2.fromTo(B,C); let lineBC = Line.createFromPointAndDirectionVector(B,BC);
    let AC = Vector2.fromTo(A,C); let lineAC = Line.createFromPointAndDirectionVector(A,AC);
